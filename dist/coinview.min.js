...
// CONCATENATED MODULE: ./src/_const.js
var VERSION = '1.0';
// CONCATENATED MODULE: ./src/_bridge.js
...
/* harmony default export */ var _bridge = ({
  send: send,
  receive: receive,
  init: init
});
...
coinview.init = function (payload) {
  return _bridge.init(payload).then(function (data) {
    _app = data;
...
function register(method) {
  ...
  coinview[m][f] = function (payload) {
    ...
    return _bridge.send(method, payload);
  };
}
/* harmony default export */ var app = (coinview);
// CONCATENATED MODULE: ./src/methods.js
/* harmony default export */ var methods = (['user.profile', 'user.assets', 'user.address', 'payment.create', 'navigate.back', 'navigate.close', 'navigate.toggleNavBar', 'ui.notice', 'ui.confirm', 'utils.choosePhoto', 'utils.setClipboard', 'utils.share', 'utils.scanQr', 'utils.openUrl']);
// CONCATENATED MODULE: ./src/index.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "methods", function() { return src_methods; });
...
var src_methods = methods;

/***/ })
/******/ ]);
//# sourceMappingURL=coinview.min.js.map